...
#             {
#                 "type": "text",
#                 "text": "{\n  \"pipeline_status\": \"completed\",\n  \"processing_steps\": [\n    \"Knowledge Graph Construction\",\n    \"Token-Level Entropy Generation\"\n  ],\n  \"knowledge_graph\": {\n    \"nodes\": [\n      {\n        \"id\": \"1\",\n        \"label\": \"Newton's First Law of Motion\",\n        \"properties\": {\n          \"type\": \"principle\",\n          \"description\": \"An object at rest stays at rest, and an object in motion stays in motion unless acted upon by a net external force.\",\n          \"bloom_relevance\": [\n            \"remembering\",\n            \"understanding\"\n          ],\n          \"complexity_level\": \"medium\"\n        },\n        \"entropy_score\": 5.261474644505628\n      },\n      {\n        \"id\": \"2\",\n        \"label\": \"Newton's Second Law of Motion\",\n        \"properties\": {\n          \"type\": \"principle\",\n          \"description\": \"The acceleration of an object is directly proportional to the net force acting on it and inversely proportional to its mass (F = m \\u00d7 a).\",\n          \"bloom_relevance\": [\n            \"understanding\",\n            \"applying\"\n          ],\n          \"complexity_level\": \"medium\"\n        },\n        \"entropy_score\": 5.704142832784672\n      },\n      {\n        \"id\": \"3\",\n        \"label\": \"Newton's Third Law of Motion\",\n        \"properties\": {\n          \"type\": \"principle\",\n          \"description\": \"For every action, there is an equal and opposite reaction.\",\n          \"bloom_relevance\": [\n            \"remembering\",\n            \"understanding\"\n          ],\n          \"complexity_level\": \"medium\"\n        },\n        \"entropy_score\": 4.966658915162042\n      },\n      {\n        \"id\": \"4\",\n        \"label\": \"Force\",\n        \"properties\": {\n          \"type\": \"concept\",\n          \"description\": \"A push or pull on an object resulting from the object's interaction with another object.\",\n          \"bloom_relevance\": [\n            \"remembering\",\n            \"understanding\"\n          ],\n          \"complexity_level\": \"low\"\n        },\n        \"entropy_score\": 4.730431845134527\n      },\n      {\n        \"id\": \"5\",\n        \"label\": \"Mass\",\n        \"properties\": {\n          \"type\": \"concept\",\n          \"description\": \"A measure of the amount of matter in an object, typically measured in kilograms.\",\n          \"bloom_relevance\": [\n            \"remembering\",\n            \"understanding\"\n          ],\n          \"complexity_level\": \"low\"\n        },\n        \"entropy_score\": 4.640688255390938\n      },\n      {\n        \"id\": \"6\",\n        \"label\": \"Acceleration\",\n        \"properties\": {\n          \"type\": \"concept\",\n          \"description\": \"The rate of change of velocity of an object, measured in meters per second squared (m/s\\u00b2).\",\n          \"bloom_relevance\": [\n            \"remembering\",\n            \"understanding\"\n          ],\n          \"complexity_level\": \"low\"\n        },\n        \"entropy_score\": 4.769007422503859\n      },\n      {\n        \"id\": \"7\",\n        \"label\": \"Everyday Applications\",\n        \"properties\": {\n          \"type\": \"fact\",\n          \"description\": \"Newton's laws are foundational for mechanics, engineering, and sports science.\",\n          \"bloom_relevance\": [\n            \"understanding\",\n            \"applying\"\n          ],\n          \"complexity_level\": \"medium\"\n        },\n        \"entropy_score\": 4.653756708287001\n      }\n    ],\n    \"relationships\": [\n      {\n        \"source\": \"2\",\n        \"target\": \"4\",\n        \"relationship_type\": \"defines\",\n        \"properties\": {\n          \"description\": \"Newton's Second Law defines the relationship between force, mass, and acceleration.\",\n          \"strength\": 0.9,\n          \"cognitive_load\": \"medium\"\n        },\n        \"entropy_score\": 4.0\n      },\n      {\n        \"source\": \"2\",\n        \"target\": \"5\",\n        \"relationship_type\": \"requires\",\n        \"properties\": {\n          \"description\": \"Mass is a required component to calculate force using Newton's Second Law.\",\n          \"strength\": 0.8,\n          \"cognitive_load\": \"medium\"\n        },\n        \"entropy_score\": 5.5\n      },\n      {\n        \"source\": \"2\",\n        \"target\": \"6\",\n        \"relationship_type\": \"requires\",\n        \"properties\": {\n          \"description\": \"Acceleration is a required component to calculate force using Newton's Second Law.\",\n          \"strength\": 0.8,\n          \"cognitive_load\": \"medium\"\n        },\n        \"entropy_score\": 3.5\n      },\n      {\n        \"source\": \"1\",\n        \"target\": \"3\",\n        \"relationship_type\": \"contradicts\",\n        \"properties\": {\n          \"description\": \"Newton's First Law and Third Law highlight different aspects of motion and forces.\",\n          \"strength\": 0.6,\n          \"cognitive_load\": \"medium\"\n        },\n        \"entropy_score\": 6.0\n      },\n      {\n        \"source\": \"7\",\n        \"target\": \"1\",\n        \"relationship_type\": \"supports\",\n        \"properties\": {\n          \"description\": \"Everyday applications support the understanding of Newton's First Law.\",\n          \"strength\": 0.7,\n          \"cognitive_load\": \"low\"\n        },\n        \"entropy_score\": 4.5\n      },\n      {\n        \"source\": \"7\",\n        \"target\": \"2\",\n        \"relationship_type\": \"supports\",\n        \"properties\": {\n          \"description\": \"Everyday applications support the understanding of Newton's Second Law.\",\n          \"strength\": 0.7,\n          \"cognitive_load\": \"low\"\n        },\n        \"entropy_score\": 5.0\n      },\n      {\n        \"source\": \"7\",\n        \"target\": \"3\",\n        \"relationship_type\": \"supports\",\n        \"properties\": {\n          \"description\": \"Everyday applications support the understanding of Newton's Third Law.\",\n          \"strength\": 0.7,\n          \"cognitive_load\": \"low\"\n        },\n        \"entropy_score\": 6.5\n      }\n    ],\n    \"metadata\": {\n      \"total_nodes\": 7,\n      \"total_relationships\": 6,\n      \"dominant_bloom_level\": \"understanding\",\n      \"complexity_score\": 0.65,\n      \"avg_node_entropy\": 5.1,\n      \"max_entropy_node\": \"f=m\\u00d7af\",\n      \"entropy_distribution\": \"skewed_high\"\n    }\n  },\n  \"entropy_analysis\": {\n    \"total_nodes\": 7,\n    \"total_relationships\": 7,\n    \"avg_node_entropy\": 4.960880089109809,\n    \"high_entropy_nodes\": []\n  }\n}",
#                 "annotations": null,
#                 "_meta": null
#             }
#         ],
